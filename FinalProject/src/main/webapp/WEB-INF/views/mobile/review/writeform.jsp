...
<form action="/Mobile/Users/Writeform" method="post" enctype="multipart/form-data">
<div class="container">
    <main>
        <div class="header">
        ...
        <div class="content">
            ...
            <input type="hidden" id="store_idx" name="store_idx"  value="90">
            <button type="submit" class="submit-btn" style="margin-top: 10px;">완료</button>
        </div>
    </main>
</div>
</form>
