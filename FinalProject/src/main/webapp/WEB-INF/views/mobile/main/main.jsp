...
.carousel-item img {
  ...
  .ongoingfilter {
    ...
    left: calc(50% - 1000px); /* 왼쪽으로 100px 이동 (1000px의 절반 만큼) */
...
@media (max-width: 360px) {
  ...
  .mainfilter, .regionfilter, .agefilter, #calendarInput, .resetbutton {
    font-size: 70px;
    padding: 15px;
    margin: 10px 0;
  }
